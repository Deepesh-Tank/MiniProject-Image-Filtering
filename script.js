...
function doRedFilter(){
  if (loaded(redImage)){
    ...
    /*I wrote the following code so that the red filter doesn't apply on the picture again when you came back to this filter after applying another filter (this is the current solution i found )
    note : with this current code double clicking on the filter button resets the image to original 
    */  
    redImage = new SimpleImage(imageUpload);
  }
...
/*I wrote the following code so that the green filter doesn't apply on the picture again when you came back to this code after applying another filter (this is the current solution i found )
note : with this current code double clicking on the filter button resets the image to original 
*/    
    greenImage = new SimpleImage(imageUpload);
  }
...
/*I wrote the following code so that the blue filter doesn't apply on the picture again when you came back to this code after applying another filter (this is the current solution i found )
note : with this current code double clicking on the filter button resets the image to original 
*/    
    blueImage = new SimpleImage(imageUpload);
  }
